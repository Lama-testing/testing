...
def test_2(driver):
    ...
    def test_4(driver):
        ...
        btn_search.click()
        sleep(5)
        saved_item = driver.find_element(By.XPATH,
                                         "//button[@class='BpkSaveButton_bpk-save-button__vYPc- bpk-save-button__default']")
        saved_item.click()
        sleep(1.5)
        btn_view = driver.find_element(By.XPATH,
                                       "//button[@class='BpkButton_bpk-button__J0Ljq BpkButton_bpk-button--link-on-dark__asVWZ']")
        btn_view.click()
        sleep(5)
    ...
    def test_5(driver):
        ...
        sleep(5)
        saved_item = driver.find_element(By.XPATH,
                                         "//div[@class='BpkSaveButton_bpk-save-button__heartIcon__QCVLd BpkSaveButton_bpk-save-button__icon__udiKX BpkSaveButton_bpk-save-button__heartIcon--default__AP4HH']")
        saved_item.click()
        sleep(3)
        Header = driver.find_element(By.XPATH,
                                     "//h2[@class='BpkText_bpk-text__aIB-U BpkText_bpk-text--heading-2__ir1RO LoginIntro_login-intro__title__qM9RF']")
